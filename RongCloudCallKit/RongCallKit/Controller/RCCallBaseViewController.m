...
@property(nonatomic,assign) BOOL isFlipx;//是否需要镜像
...
- (void)cameraSwitchButtonClicked {
    ...
    BOOL isSuccess = [self.callSession switchCameraMode];
...
-(FUAPIDemoBar *)demoBar{
    if (!_demoBar) {
        _demoBar = [[FUAPIDemoBar alloc] initWithFrame:CGRectMake(0,200 , self.view.frame.size.width, 164)];
