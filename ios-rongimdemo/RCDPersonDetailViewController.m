...
@interface RCDPersonDetailViewController () <UIActionSheetDelegate, FUAPIDemoBarDelegate>
...
/**
 ...
 @param bar FUAPIDemoBar不是我们的交付内容，它的作用仅局限于我们的Demo演示，客户可以选择使用，但我们不会提供与之相关的技术支持或定制需求开发
 */
-(FUAPIDemoBar *)bar {
    if (!_bar ) {
